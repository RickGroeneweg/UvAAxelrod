...
us = Country("United States", 300, Washington, 0.1,0.1, defect)
...
australia = Country("Australia", 25, Canberra, 0.1,0.1, collaborate)
...
tour = Tournament(netherlands, germany, uk, france, italy, sweden, denmark, belgium, china, \
    india, us, canada, russia, southKorea, australia, spain, \
    israel, ireland, finland, portugal, brazil, indonesia, pakistan, nigeria,\
    egypt, mexico)

tourtje = Tournament(netherlands, southKorea, finland, australia, belgium)
